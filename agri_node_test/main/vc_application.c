...
void vc_application_start(void)
{
    ...
    while (1)
    {
        ...
        case STATE_PROCESS_DATA:
        {
            ...
            tx_payload.temperature = (int16_t)(current_temp * 100.0f);
            tx_payload.humidity = (uint16_t)(current_hum * 100.0f);
            tx_payload.leaf_wetness = (uint16_t)(current_leaf * 100.0f);
            tx_payload.soil_moisture = (uint16_t)(current_moisture * 100.0f);
